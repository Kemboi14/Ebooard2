...
urlpatterns = [
    ...
    path('<uuid:pk>/update/', views.EvaluationUpdateView.as_view(), name='evaluation_update'),
    ...
    path('templates/populate-professional/', views.populate_professional_templates, name='populate_professional_templates'),
